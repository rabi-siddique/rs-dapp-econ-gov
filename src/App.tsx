...
const NetPicker = (props: { currentNet: string }) => {
  ...
  return (
    <Menu as="div" className="mb-2 mr-2 relative inline-block text-left">
      <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-5 px-4 py-3 text-md font-medium text-primary hover:bg-opacity-10 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
        {props.currentNet}
        <FiChevronDown
        ...
        <div className="min-w-screen container p-4 mx-auto flex flex-wrap justify-between items-center">
          ...
          <div>
            ...
            <a
              ...
              className="no-underline inline-flex justify-center rounded-md bg-black bg-opacity-5 px-4 py-3 text-md font-medium text-primary hover:bg-opacity-10 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
            >
              {address}
